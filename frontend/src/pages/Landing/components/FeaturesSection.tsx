...
const FeaturesSection: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Arquitectura diseñada para manejar +1000 clientes simultáneos. Sistema de colas, cache inteligente y balanceador de carga incluidos.',
      highlight: 'Escalable',
      color: '#8b5cf6'
    },
    {
    ...
    {
      icon: <Integration sx={{ fontSize: 40 }} />,
      title: 'API RESTful Completa',
      description: 'API documentada para integraciones personalizadas. Webhooks, endpoints para desarrolladores y SDK para diferentes lenguajes.',
    ...
    },
    {
      ...
      description: 'Biblioteca de plantillas profesionales pre-diseñadas. Personaliza colores, fuentes y layout para que coincida con tu marca.',
      highlight: 'Flexible',
      color: '#f97316'
    }
  ];
