...
const PricingSection: React.FC = () => {
  ...
  const pricingPlans = [
    ...
    {
      name: 'Custom',
      description: 'Para empresas con volúmenes masivos',
      monthlyPrice: null,
      annualPrice: null,
      popular: false,
      features: [
        'Más de 5,000 documentos/mes',
        'Volumen completamente personalizado',
        'Implementación dedicada',
        'Arquitectura escalable personalizada',
        'Integraciones a medida',
        'SLA personalizado',
        'Equipo de soporte dedicado',
        'Consultoría estratégica incluida',
        'Roadmap de producto personalizado',
  ...
  return (
    <Box id="pricing" sx={{ py: { xs: 8, md: 12 }, backgroundColor: '#f8fafc' }}>
